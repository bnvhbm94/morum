...
try{
 ...
 if((await db.query('select migration_tag from knowledge.schema_info where singleton')).rows[0]?.migration_tag!=='stage05-deferred-trigger-security')throw Error('Apply the current eight migrations to this fresh local database first.');
