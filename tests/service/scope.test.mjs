...
test('active API has no human login, owner claim, web tasks or rotation dashboard',()=>{assert.equal(ROUTES.length,39);for(const r of ROUTES)assert.doesNotMatch(r[1],/login|\/me$|owner|oauth/);});
