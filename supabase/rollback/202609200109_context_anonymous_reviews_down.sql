-- Rollback for 202609200109_context_anonymous_reviews.sql.
-- Restores the review_heads-only walk exactly as defined in 202609200105_retrieval.sql
-- and the stage05 health tag. Run only if the forward migration must be undone.
BEGIN;
